        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="animate-fade-in">
            ...
            <button
              ...
              className="w-full flex items-center justify-center border border-[#E2E8F0] text-[#1A202C] rounded-full h-12 font-medium hover:bg-[#F9FAFB] transition-colors bg-white"
